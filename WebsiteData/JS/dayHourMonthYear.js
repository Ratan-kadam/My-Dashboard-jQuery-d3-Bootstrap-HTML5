...
function loadMonthly() {
 // alert("monthly");
    clearCssStack();
     document.getElementById("trips-monthWiseUserType").classList.remove("hideMe");
     document.getElementById("trips-monthWiseUserType").classList.add("displayMe");
}

function loadDaily() {
   // alert("daily");
    clearCssStack();
    document.getElementById("trips-dayWiseUserType").classList.remove("hideMe");
     document.getElementById("trips-dayWiseUserType").classList.add("displayMe");
}

function loadWeekly() {
  //  alert("weekly"); 
    clearCssStack();
    document.getElementById("trips-weekWiseUserType").classList.remove("hideMe");
     document.getElementById("trips-weekWiseUserType").classList.add("displayMe");
}

function loadHourly() {
   //  alert("hourly");
    clearCssStack();
    document.getElementById("trips-hourWiseUserType").classList.remove("hideMe");
     document.getElementById("trips-hourWiseUserType").classList.add("displayMe");
}
...
function clearCssStack(){
     //
    document.getElementById("trips-monthWiseUserType").classList.remove("hideMe");
    document.getElementById("trips-dayWiseUserType").classList.remove("hideMe"); //dp
    document.getElementById("trips-weekWiseUserType").classList.remove("hideMe"); //ad
    document.getElementById("trips-hourWiseUserType").classList.remove("hideMe"); //ad

    //
    document.getElementById("trips-monthWiseUserType").classList.remove("displayMe");
    document.getElementById("trips-dayWiseUserType").classList.remove("displayMe");
    document.getElementById("trips-weekWiseUserType").classList.remove("displayMe");
    document.getElementById("trips-hourWiseUserType").classList.remove("displayMe");
    
    //
    document.getElementById("trips-monthWiseUserType").classList.add("hideMe");
    document.getElementById("trips-dayWiseUserType").classList.add("hideMe");
    document.getElementById("trips-weekWiseUserType").classList.add("hideMe");
    document.getElementById("trips-hourWiseUserType").classList.add("hideMe");
   // alert("clear stack completed ");
...
function loadDataHourDay() {
    ...
    $.getJSON("/WebsiteData/HTML/data/" + yearSelected + "Monthwise.json", function(data) {
        ...
        $.getJSON("/WebsiteData/HTML/data/" + yearSelected + "Daywise.json", function(data) {
            ...
            $.getJSON("/WebsiteData/HTML/data/" + yearSelected + "Hourwise.json", function(data) {
                _.forEach(data, function(eachTrip) {
